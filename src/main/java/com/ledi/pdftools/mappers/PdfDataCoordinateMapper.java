...
public interface PdfDataCoordinateMapper {
    ...
    @Update("update pdf_data_coordinate set page_no=#{pageNo}, field_type=#{fieldType}, field_category=#{fieldCategory}, field_name=#{fieldName}, llx=#{llx}, lly=#{lly}, urx=#{urx}, ury=#{ury}," +
